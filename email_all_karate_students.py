...
retval = pd.read_sql("""
                    ...
                    union all
                    select 
                    email2 as `email_addresses` 
                    from ptkd_students
                    where active = 1
                    and krt_tkd = "krt"
                    and email2 is not null and email2 != "" and email2 != " "
                    union all
                    select 
                    email3 as `email_addresses` 
                    from ptkd_students
                    where active = 1
                    and krt_tkd = "krt"
                    and email3 is not null and email3 != "" and email3 != " "
;
                    """, 
                    cnxn)
...
msg["Subject"] = "Performance MA - Karate Students"
...
finalstring = """Hi Karate students/parents,
