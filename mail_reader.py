...
print("Total Fees w/ Receipts: $" + str("{:.2f}".format(fees_sum)) + ", " + str(len(list_tuitionfees)) + " records")
print("Total Gear Fees w/ Receipts: $" + str("{:.2f}".format(gear_sum)) + ", " + str(len(list_gearfees)) + " records")
print("Total Testing/Credits Collected: $" + str("{:.2f}".format(other_sum)) + ", " + str(len(newcreditlist)) + " records")